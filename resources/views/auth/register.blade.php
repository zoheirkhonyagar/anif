                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('tel') ? ' has-error' : '' }}">
                            <label for="phone-number" class="col-md-4 control-label">شماره موبایل</label>

                            <div class="col-md-6">
                                <input id="phone-number" type="tel" class="form-control" name="phone_number" value="{{ old('number') }}" required>
