...
//      $url = 'http://anif.ir/'.'images/stores/'.$store['id'].'/';
    ...
    public function getOfferStores($perPage = 9, $currentPage = 1, $decodeImages = true, $cityId = 1, $region_id = 0, $sortBy = 'sort_weight', $sortType = 'desc', $filterType ,$storeCategory = 0)
    {
